...
) ENGINE=InnoDB AUTO_INCREMENT=6752 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `category` VALUES (1,'luggage','small','소분류없음'),(2,'luggage','small','소분류없음'),(3,'luggage','middle',NULL),(4,'luggage','middle',NULL),(5,'luggage','large',NULL),(6,'backpack','business',NULL),(7,'backpack','business',NULL),(8,'backpack','casual',NULL),(9,'backpack','casual',NULL),(10,'backpack','other',NULL),(11,'backpack','other',NULL),(12,'luggage','middle',NULL),(13,'luggage','large',NULL),(14,'backpack','casual',NULL),(15,'luggage','large',NULL);
...
CREATE TABLE `managesummary` (
  `mng_id` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`mng_id`),
...
-- Dump completed on 2022-05-01 23:54:32
